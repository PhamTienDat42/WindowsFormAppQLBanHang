...
alter proc Insert_tblNhaCungCap
@maNCC int,
@tenNCC varchar(50),
...
alter proc Update_tblNhaCungCap
@maNCC int,
@tenNCC varchar(50),
@tenGiaoDich varchar(50),
@diaChi varchar(50),
...
Alter proc Select_tblDonDatHang_tblChiTietDatHang
as 
...
Alter proc Select_tblDonDatHang_tblChiTietDatHang1
@maHD int
as 
Select tblDonDatHang.iSoHD, iMaNV, iMaKH, dNgayDatHang, dNgayGiaoHang, fTongTienHD, sMaHang, fGiaBan, iSoLuongMua, fMucGiamGia
...
alter proc Select_tblChiTietDatHang 
@maHD int
as
...
alter proc Update_tblChiTietDatHang
@maHD int, 
@maHang varchar(30),
@giaBan float,
@soLuong int ,
...
alter proc Delete_tblChiTietDatHang
@maHD int,
@maHang varchar(50)
as 
Delete From tblChiTietDatHang Where iSoHD = @maHD and sMaHang = @maHang;

alter proc Select_DSDonDatHang
@fromDate date,
@toDate date
as
...
alter proc Select_tblChiTietNhapKho
@maNK int
as
...
Create proc Insert_tblChiTietNhapKho
@maNK int,
@maHang varchar(50),
@giaNhap float,
@soLuongNhap float
